...
class autoLogin 
{
	...
	private function showPageLoggedIn(){
		...
		header('Location: https://raven.anr.udel.edu/~modupe/bigbird/db_entry.php');
	}
	private function showPageLoginForm(){
		...
		echo '';
		echo '<tr><td><form method="post" action="' . $_SERVER["https://raven.anr.udel.edu/~modupe/bigbird/index.php"] . '" name="loginform">';
